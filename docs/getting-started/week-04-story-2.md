...
*Print this page on cardstock. Two copies in the room — one for the Lead Companion, one for the Co-Companion team. A third copy goes to the rotation leader with Handout H4.1. Week 4 carries the same disclosure risk as Week 3 and adds a first-time leader. Read the Crisis Contingencies section below before walking in.*

## WEEK 4 — TELLING YOUR STORY II (90 minutes)

**Aim.** The rest of the group tells — every participant who did not tell in Week 3 tells their four-question story to their circle and receives a spoken blessing. Nothing new is taught. The completion is the point. And it is the rotation’s first marquee slot: a member leads the container open and close, the story facilitation in their circle, and the blessing round, protocol card in hand, with an experienced Companion in the room.
...
A Co-Companion takes this block, same as Week 3.
...
# Differentiation in the Circles
...
Then stay seated, stay present, keep your face soft, say nothing more. The experienced Companion holds it from there; when the circle is steady, they will hand the process back to you. **The handoff is the competence, not a failure.** You are not the counselor tonight, you never count as one of the two Companions for a disclosure, and you never take one. Those three rules are the whole of your safety — and theirs.
