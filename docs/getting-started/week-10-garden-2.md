...
*The second guided run — the cohort returns to the garden deeper for a week of practice; a rotation leader leads the walk-through, and the Companion holds the debrief*
...
*Print this page on cardstock. Two copies in the room. This session teaches nothing new. It completes what Week 9 began — and it is the clearest single illustration in Getting Started of the bright line: the rotation leader leads the walk-through; the experienced Companion holds the debrief.*

## WEEK 10 — THE GARDEN OF YOUR HEART II (90 minutes)

**Aim.** The second guided run of the Garden of Your Heart. Participants return to the garden with a week of practice behind them, and go deeper for it. A rotation leader leads the guided walk-through from the protocol card; the experienced Companion holds the debrief and anything that surfaces.
...
**Center.** The guided imaginative prayer runs again, 12–15 minutes, read from the same protocol as Week 9 — but tonight, in the circles with a rotation leader assigned, one of the cohort reads it. The experienced Companion is in the circle the whole time, and the moment the walk-through ends, the room passes visibly to the Companion for journaling and sharing. Sharing remains by invitation only — silence is a complete answer.

**The bright line, in one sentence.** The walk-through is process leadership — scripted, repeatable, a member's to lead once they have received it. The debrief is care leadership — disclosure-bearing by nature — and it is NEVER the first-time leader's to hold (the bright line; the three rules).
...
- The rotation leader rushing the silences. This is the single most common failure of a first-time guide. The words are easy; the pauses are the work. Rehearse the silences in pre-work by counting them out, and watch for it live.
...
- The spotlight distorting the rotation leader's lead. Tonight is not a performance and must not be framed as one. A script read slowly is completely acceptable — say so out loud to the rotation leader before the night and to the room at the split.
...
**If something surfaces DURING the guided walk-through — crying that is more than tears, visible distress.** Two roles, both rehearsed in pre-work. The rotation leader keeps the room steady: same pace, same volume, do not stop reading, do not look up sharply — the walk-through continues for everyone else. The Companion moves to the person: quietly alongside them, a whisper — "I'm here. You can open your eyes whenever you want. Jesus is not in a hurry." If they need to step away, the Companion steps to the doorway with them, in sight of the room, and signals the Lead Companion if more is needed. The rotation leader's only job in that moment is the rest of the circle. The Companion's only job is the one person. Neither covers for the other.

**If something painful surfaces in the sharing.** The sharing is already the Companion's room. Receive without interpreting. Bless. Follow up offline within 48 hours. Section 6 protocol for any disclosure that crosses the safety threshold.

**If a disclosure begins while the rotation leader is nearby.** Rule 2 never bends: a rotation leader never takes a disclosure. Their only job is to hand it to the Companion immediately — and the Companion receives the handoff without hesitation and without commentary, so the handing costs the rotation leader nothing.

**If the participant who stayed out of the garden is distressed by staying out.** Staying out was the faithful choice tonight and should be named as such, privately: "You did exactly the right thing. The garden will keep. So will He." Pastoral 1:1 if welcomed.
...
**If the overwhelm goes past what the two-role protocol holds.** For that participant, the Companion runs the Settle Protocol (Handbook §6) — stop for them, not for the circle: plain directive words, back to the room, breathe and anchor, no return to the exercise tonight. The rotation leader keeps the walk-through steady for everyone else. Nobody leaves activated — a Companion stays until their body has settled, and settling that doesn’t come is a same-evening call to the backup.

# Session at a Glance

## Why this session, this week

Getting Started runs its deepest practices twice. The first running is Companion-led, and the cohort receives it. The second running completes it — most participants only get all the way in on the second visit — and the second running is the slot a rotation leader leads, protocol in hand, with an experienced Companion in the room. See one, do one, in the same series, in front of the cohort.

Tonight is that mechanism at its most important, because the Garden is the deepest water in the series. And so tonight is also the clearest illustration of the bright line the whole leadership pathway rests on: the rotation leader leads the scripted, repeatable shape — the guided walk-through — and the experienced Companion holds the disclosure-bearing center — the debrief, the sharing, and anything that surfaces. The Garden can open deep water. The debrief is disclosure-bearing by nature. It is never the first-time leader's to hold, and tonight the whole cohort watches that line honored in real time. That witness is itself formation: the room learns that leadership has a shape, and its leaders learn that the shape is what keeps everyone safe.
...
- Week 9: the garden was opened, Companion-led. Every participant has been there once; most have returned during the week. Tonight assumes the place is known and goes deeper into it.
- Week 8: PROAPT II — the cohort has already watched one second running, member-led. The shape of tonight is familiar even though the depth is not.
...
This is the heart of the week's pre-work. Three parts, none optional.

1. **The rotation leader has been back.** Before they lead, the rotation leader has returned to the garden themselves at least three times since Week 9. This is rule 3 — lead only a block you have first received — applied honestly: you cannot lead where you have not been, and a guide who has made the return trip reads the room's returns truly. The Lead Companion asks directly, and kindly: "Have you been back? What was it like?" If the answer is no, the slot moves to a Companion this cycle, without shame, and the rotation leader leads a later running. The rule protects them.
2. **A full-pace rehearsal with the Lead Companion.** The rotation leader reads the entire protocol (H10.1) out loud, at performance pace, with the Lead Companion as the room. Attention goes to pacing and the long silences. Most first-time guides rush — not from carelessness but from the fear that silence means something is wrong. Rehearse the silences by counting them out: where the card says thirty seconds, the rotation leader counts thirty, silently, at rehearsal speed, until thirty seconds stops feeling like a cliff. Say it plainly: "The protocol carries the room; your job is pace and presence, not performance." A script read slowly is completely acceptable — it is, in fact, the assignment.
3. **Rehearse the mid-walk-through distress protocol once.** Walk it physically. The Lead Companion plays a participant in visible distress; the rotation leader practices continuing to read — same pace, same volume, eyes on the card — while the Companion moves. One rehearsal is enough. The point is that the rotation leader's body has done it once before it matters.
...
2. Confirm the leading assignments: which circle the rotation leader leads, and which experienced Companion holds each circle's debrief. In circles without a rotation leader, the Companion leads the walk-through as in Week 9.
3. Walk the handoff beat out loud — the visible pass from leader to Companion at the end of the walk-through. It should be rehearsed enough to be unhurried.
...
6. Confirm pastoral / clinical backup.
7. Pray for each participant by name, and for the rotation leader by name.
...
| **When** | **Action** | **Who** |
| --- | --- | --- |
| Week before | The leader's three garden returns confirmed. Full-pace rehearsal with the Lead Companion, silences counted out. Distress protocol walked once. Handouts printed. Pastoral backup confirmed. | Lead Comp + leader |
...
| T-45 min | Team gathers. Walk the handoff beat and the crisis scenarios. Pray for each participant and for the rotation leader. | All Companions |
...
| --- | --- | --- | --- | --- |
| 6:45–7:00 | Arrival window | Single circle (forming) | Co-Comp | Door, name tags, phone-box. Quiet check-in at the door with anyone flagged for a pre-session word. Quieter than usual. |
| 7:00–7:07 | Block 1: Welcome and centering | Shared circle | Lead Comp | Aaronic blessing. Frame the second run and name, simply, that one of the cohort leads the walk-through tonight. |
...
| 7:29–8:02 | Block 5: The Garden exercise in cohort circles | Cohort circles | Leader + Companions | Member-led guided walk-through (12–15 min, longer silences); the visible handoff; silent journaling (5 min); Companion-held sharing by invitation only (10–12 min). |
...
| 8:11–8:16 | Block 7: Between-session practice | Shared circle | Co-Comp | Two returns to the garden this week. Journal each visit. |
| 8:16–8:22 | Block 8: Closing container | Shared circle | Lead Comp | Reaffirm. Aaronic blessing. |
| 8:22–8:30 | Block 9: Leader Feedback Round | Shared circle | Lead Comp | Full order. Placed AFTER the closing container — see the note in Block 9. If the debrief ran heavy, this moves to the team debrief and the rotation leader is told why. |
...
*“One thing is different tonight, and I want to name it simply. In the circles, the guided walk-through will be read by [name] — one of us, who has been preparing for this, and who has been back to their own garden this week to get ready. The words are the same words. They will read from the card, slowly, the same way I did. And when the walk-through is finished, your Cohort Companion takes the room for the journaling and the sharing, same as last week. Nothing about the container changes. What is said in your circle stays in your circle. Nothing is required — not even doing the exercise.”*

*“Listen to receive.”*

### Note for the Lead Companion

Name the rotation leader once, warmly, and move on. Do not build it up — a spotlight distorts the very thing the slot is meant to form. The cohort should hear it the way they would hear any other assignment of parts.
...
*“Same two passages as last week. You have spent a week inside their imagery now. Listen as if for the first time anyway.”*
...
### Teaching points (use any format — keep this brief)

• A vinedresser does not visit a vine once. The whole picture of John 15 is of repeated, patient attention — abiding is a rhythm, not an event. Tonight is the second visit of what we hope becomes a lifetime of visits.
...
Each cohort circle runs in parallel. In the circle (or circles) with a rotation leader assigned, the rotation leader reads the guided walk-through from Handout H10.1; the experienced Companion sits in the circle throughout. In circles without a rotation leader, the Companion leads from H9.1 exactly as in Week 9.

### Structure inside the cohort circle

## Phase 1 — Settle (2 min)

**The experienced Companion opens the circle — the container is theirs to set. “Take a breath. Settle. Eyes open or closed. Whatever feels honest. We have time.” Then, simply: “[Name] will read for us tonight.” Two minutes of quiet.**

## Phase 2 — Guided walk-through, member-led (12–15 min)

**The rotation leader reads the protocol from H10.1, slowly, with the marked pauses held at full length — tonight's pauses run longer than Week 9's, and the card marks them. Reading from the card is not a fallback; it is the design. The protocol carries the room; the rotation leader's job is pace and presence, not performance.**

**The experienced Companion's job during the walk-through is the room, not the reader. Do not mouth along, do not conduct, do not audibly approve. Watch bodies. You are the one who moves if someone needs you.**

**If distress surfaces mid-walk-through — crying that is more than tears, visible distress — both roles hold: the rotation leader keeps reading, same pace, same volume, eyes on the card; the Companion moves quietly to the person. The walk-through continues for everyone else. This was rehearsed. Trust the rehearsal.**

## The handoff — the visible pass (under 1 min)

**The moment the walk-through ends — after “Open your eyes when you are ready” and the room has come back — leadership passes visibly to the Companion. This is a deliberate, dignified beat, not an interruption. Script it:**

**The rotation leader, turning to the Companion, unhurried: *“[Name], the room is yours.”***

**The Companion, receiving it: *“Thank you, [name]. That was well led.”* One sentence of thanks — no more, this is not the feedback round — and then the Companion carries everything from here: the journaling, the sharing, and anything that surfaces.**
...
**Companion-led from here. “Take five minutes. Write in your journal what you noticed. What was the same as last week, what was different, and whatever else is true.”**

## Phase 4 — Sharing by invitation (10–12 min)

**“We have a few minutes for sharing. By invitation only. Silence is a complete answer.” The experienced Companion goes first, briefly — two sentences, simple — and then around the circle.**
...
**If a share surfaces something painful, bless briefly — “I hear that. May Jesus stay with you in that place this week” — move on, and follow up offline within 48 hours. Section 6 protocol for anything that crosses the safety threshold. The rotation leader does not take any of this, even a fragment of it; if someone turns toward the rotation leader with something heavy, the rotation leader hands it to the Companion immediately (rule 2), and the Companion receives the handoff without hesitation.**

**The participant who stayed out of the garden shares or stays silent on exactly the same terms as everyone else. Do not draw attention to their staying out — in the circle, honoring it means treating it as unremarkable.**

### rotation leader: special considerations

- Read slowly. Two words per second is closer to right than three. The rehearsal pace is the performance pace.
- The pauses are the exercise. Where the card marks thirty seconds, hold thirty seconds — count silently if you need to. Tonight's marked pauses are longer than last week's on purpose. Silence does not mean something is wrong; silence means the work is happening.
- Do not improvise, embellish, or add your own experience. The card carries the room. Your job is pace and presence, not performance.
- If someone opens their eyes, do not react. If someone softly cries, do not stop — the tears are often the work. If someone is in real distress, the Companion moves; you keep reading, same pace, same volume.
- When the walk-through ends, hand the room to the Companion, out loud, without hurry. The handing is part of the leading.

### The experienced Companion: special considerations

- The container is yours before the reading, the room is yours during the reading (watch bodies, be ready to move), and everything after the reading is yours. The rotation leader carries only the card.
...
*“Same gentle word as last week: if a return surfaces something heavy, you can stop, open your eyes, and come back another day. And tell someone — your circle Companion, your spouse, someone you trust. You are not meant to carry the heavy things alone.”*
...
The Leader Feedback Round runs after the closing container tonight — not, as in other member-led weeks, immediately after the member has led. The placement is deliberate: the Garden debrief must not be interrupted by process feedback. The room comes out of Block 5 carrying tender things, and asking it to evaluate a leader before those things are sealed under the closing blessing would break the very container the rotation leader helped hold.

**And if the debrief ran heavy** — if the sharing surfaced something that is still visibly in the room at 8:24 — skip this block entirely. The feedback round moves to the team debrief tomorrow, and the Lead Companion tells the rotation leader why, in exactly these terms: protecting the room came first tonight. That sentence is not a consolation; it is the lesson. A leader who watches their own feedback round yielded to the care of the room has learned the bright line from the inside.

When it runs, it runs in the fixed order:

1. The team names what the rotation leader did well and would want to see again — pace and the held silences are usually the honest headline.
2. The team names one thing — one, not a list — to try differently next time.
3. Ask the rotation leader: *“Would you like feedback from the group too?”* The rotation leader decides. If no, the round ends here. No pressure, no exposure.
4. If yes, popcorn-style to the group: *“What worked well for you? What is one suggestion for them to consider next time?”*

*Stay accessible after the close for at least fifteen minutes, two Companions for anything that runs deep. Tonight, like Week 9, some will need to talk.*
...
- PROAPT one short passage daily — carried forward.
- Two returns to the garden (the rhythm continues). 5–10 minutes each, two days this week. Journal each visit — even two sentences.

The load drops from three visits to two on purpose. Week 9 opened the practice at high intensity; from here the goal is a rhythm that survives, not a sprint that impresses. Two visits, journaled, is the shape of a garden habit that could still be alive in a year.

# Companion Debrief Prompts

Companion team meets the day after Week 10 for a 45-minute debrief. Two subjects tonight, kept distinct: the room, and the rotation leader. Take the room first.
...
- The rotation leader read at rehearsal pace and did not perform.

### Signs the session did not work as well as it could have

- The rotation leader rushed the silences and no one had rehearsed them hard enough to prevent it.
- The feedback round ran when the room was still heavy, or interrupted the debrief's afterglow.
- Sharing slid into interpretation — the second-week confidence problem.
- Comparison language went unanswered and someone left believing their garden was lesser.
- A flagged participant got no pre-session check-in.
...
### The rotation leader — prompts

- How did the pacing hold? Where specifically did it rush, and was it the silences, the reading, or the handoff?
- If the feedback round moved to this meeting because the debrief ran heavy: run it now, same fixed order, and confirm the rotation leader heard why it moved — protecting the room is the lesson, and it should be said to them in exactly those words.
...
- Anyone whose share crossed into tender territory. Contact within 48 hours.
- Anyone who stayed out of the garden and seemed burdened rather than settled by it. Pastoral 1:1 if welcomed.
- Anyone who reported the second visit was flatter or emptier than the first and seemed troubled. Warm contact: “The garden has quiet weeks. You did the practice.”
- The rotation leader — a brief, specific word of thanks from the Lead Companion, separate from the feedback round. Leading deep water for the first time costs something. Name that it was seen.
...
**Handout H10.1 — The rotation leader's Garden Guide Card**

*One card, cardstock, for the rotation leader leading the walk-through. This is the Week 9 protocol (your cohort's version) with pacing marks added and the two handoff rules printed where you cannot miss them. Rehearse from this exact card. Lead from this exact card.*

### The two handoff rules (read these first, every time)

**1. When the walk-through ends, the room is the Companion's — hand it visibly.** After “Open your eyes when you are ready,” wait for the room to come back. Then turn to your Companion and say, unhurried: *“[Name], the room is yours.”* You do not lead the journaling. You do not lead the sharing. You do not take anything anyone brings to you afterward — if someone turns to you with something heavy, your only job is to hand it to the Companion immediately. You are not the counselor; you are a guide who finished the walk and handed off well. Handing off well IS the leading.

**2. If distress surfaces mid-walk-through, the Companion moves — you keep reading.** If someone begins crying in a way that is more than tears, or shows real distress: do not stop, do not look up sharply, do not change your pace or volume. The Companion in your circle is already moving to them. The walk-through continues for everyone else, and your steadiness is what makes that possible. You rehearsed this. Trust the rehearsal.

### Pacing marks (they govern the whole card)

- **Read at two words per second.** Slower than feels natural. The rehearsal pace is the performance pace.
- **(pause) = thirty full seconds.** Count them silently. Do not shave them.
