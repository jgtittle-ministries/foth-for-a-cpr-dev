...
*Print this page on cardstock. Two copies in the room. This session teaches nothing new. It completes what Week 9 began — and it is the clearest single illustration in Getting Started of the bright line: the teen leads the walk-through; the adult holds the debrief.*

## WEEK 10 — THE GARDEN OF YOUR HEART II (90 minutes)

**Aim.** The second guided run of the Garden of Your Heart. Participants return to the garden with a week of practice behind them, and go deeper for it. A Companion-in-Formation leads the guided walk-through from the protocol card; the adult Companion holds the debrief and anything that surfaces.
...
**If a disclosure begins while the senior is nearby.** Rule 2 never bends: a Companion-in-Formation never takes a disclosure. Their only job is to hand it to the adult immediately — and the adult receives the handoff without hesitation and without commentary, so the handing costs the senior nothing.
...
1. **The senior has been back.** Before they lead, the senior has returned to the garden themselves at least three times since Week 9. This is rule 3 — lead only a block you have first received — applied honestly: you cannot lead where you have not been, and a guide who has made the return trip reads the room's returns truly. The Lead Companion asks directly, and kindly: "Have you been back? What was it like?" If the answer is no, the slot moves to an adult this cycle, without shame, and the senior leads a later running. The rule protects them.
2. **A full-pace rehearsal with the Lead Companion.** The senior reads the entire protocol (H10.1) out loud, at performance pace, with the Lead Companion as the room. Attention goes to pacing and the long silences. Most first-time guides rush — not from carelessness but from the fear that silence means something is wrong. Rehearse the silences by counting them out: where the card says thirty seconds, the senior counts thirty, silently, at rehearsal speed, until thirty seconds stops feeling like a cliff. Say it plainly: "The protocol carries the room; your job is pace and presence, not performance." A script read slowly is completely acceptable — it is, in fact, the assignment.
3. **Rehearse the mid-walk-through distress protocol once.** Walk it physically. The Lead Companion plays a participant in visible distress; the senior practices continuing to read — same pace, same volume, eyes on the card — while the adult moves. One rehearsal is enough. The point is that the senior's body has done it once before it matters.
...
7. Pray for each participant by name, and for the senior by name.
...
**The moment the walk-through ends — after “Open your eyes when you are ready” and the room has come back — leadership passes visibly to the adult. This is a deliberate, dignified beat, not an interruption. Script it:**
...
**If a share surfaces something painful, bless briefly — “I hear that. May Jesus stay with you in that place this week” — move on, and follow up offline within 48 hours. Section 6 protocol for anything that crosses the safety threshold. The senior does not take any of this, even a fragment of it; if someone turns toward the senior with something heavy, the senior hands it to the adult immediately (rule 2), and the adult receives the handoff without hesitation.**
...
### Companion-in-Formation: special considerations
...
- The senior rushed the silences and no one had rehearsed them hard enough to prevent it.
...
- The senior — a brief, specific word of thanks from the Lead Companion, separate from the feedback round. Leading deep water for the first time costs something. Name that it was seen.
