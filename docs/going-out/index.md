...
| # | Title | Focus |
|---|---|---|
| 1 | [Welcome Back — Returning to the Sent Body](week-01-welcome-back.md) | Re-open the cohort; name the interlude; orient outward |
| 2 | [The Body Sent](week-02-body-sent.md) | What it means to be a sent body, not a sequestered one |
| 3 | [Where Sent](week-03-where-sent.md) | The four contexts: household, vocational, third place, beyond |
| 4 | [Daily Tells](week-04-daily-tells.md) | The weekly practice of telling outside the cohort |
...
Same shape as the other two series:

- **Quick Reference Card** — print on cardstock; two copies in the room.
- **WATCH FOR** — the specific risks of this session.
- **Session at a Glance** — aim, anchor scripture, Connect focus, mode, center, between-session practice, IJH source.
- **Pre-Work** for the Companion team and participants.
- **Materials and Setup** — checklist, room arrangement, prep timeline.
