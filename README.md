# Fellowship of the Heart — For a Church Prepared for Revival

**Working label: FotH for a CPR. Dev repo only — there is no prod, no site, and no mirror for this work yet.**

This is the adult edition of the Fellowship of the Heart sequence: the original three-series design (Getting Started, Going Deeper, Going Out) being retrofitted with everything learned in building the twenty-two-week CCA year.

## What this is for

A church says: *we are interested in trying this out.* This sequence is the answer, and the answer is a challenge before it is a curriculum: **the leadership-first challenge**. Before anything reaches that church's families or teens, its leaders walk the adult year themselves. First for ourselves, then for our teens — at church scale. A leadership team that completes the year is formed to lead the family edition and has proven it wants to. A leadership team that will not take the year has answered the church's question honestly, at low cost, before any family was asked to trust anything.
